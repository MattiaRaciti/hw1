...
fetch("http://localhost/hw1/get_favorites.php").then(onResponseFavorite).then(onFavorite);

fetch("http://localhost/hw1/get_like_number.php").then(onResponseLikeNumber).then(onLikeNumber);
...
function seleziona(event){
	...
	fetch("http://localhost/hw1/remove_favorites.php?param=" + indiceDaSegnareDatabase);
